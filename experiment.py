...
#######################################################################################################################
SEED = 42
RESULTS_FILENAME = 'data/results/results.pkl'
...
if __name__ == '__main__':
    ...
    estimators = [WeightedCatBoostRegressor(),SkDnnModel(),SkTransformedDnnModel()]
    ...
    for fold, (train_index, test_index) in enumerate(outer_cv.split(X, y)):
        ...
        study = optuna.create_study(
            study_name=f'Experiment-CV-{fold}',
            direction='maximize',
            storage='sqlite:///data/optuna/results.db',
            load_if_exists=True,
